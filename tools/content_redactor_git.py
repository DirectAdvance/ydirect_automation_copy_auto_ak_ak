...
INCLUDE_GLOBS = (
    ...
    "direct/core/campaign.py",
    "direct/core/direct_repository.py",
    "direct/clients/direct_v501_client.py",
    "direct/clients/gateway_client.py",
    "direct/grid_content_verifier.py",
    "direct/clients/grid_finalize.py",
    "direct/clients/grid_read.py",
    "direct/link_check.py",
    "direct/model_url_config.json",
    "direct/model_urls.py",
    "direct/clients/uac_client.py",
    "direct/clients/uac_read.py",
    "direct/clients/yandex_gateway.py",
    # Relevant tests.
