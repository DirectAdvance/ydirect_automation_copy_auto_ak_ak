...
- Статус: 🟡 фикс на Mac+LXC101 (Mutagen). py_compile OK Mac+LXC101. Тесты: 33/33 passed. Ждёт живого прогона (проверить grp 5777189791 и 5777191390 через GroupsForEdit).
