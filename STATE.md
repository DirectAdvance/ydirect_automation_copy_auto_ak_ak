...
**Осталось (не блокеры):** #23 замер/ускорение под-загрузок; keyword под-копирование перемежающееся —
самолечение как страховка (в run 20 не понадобилось, ключи легли сами).
